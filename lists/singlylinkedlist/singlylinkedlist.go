...
// Second return parameter is true if index is within bounds of list and list is not empty, otherwise false.
...
// Contains checks if value (one or more) are present in the set.
...
// Empty reutrns true if list does not contain any elements.
